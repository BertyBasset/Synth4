...
public class VCO : iModule {
    ...
    #region Constructor
    public VCO(VCOWaveformType? WaveFormType = null) {
        // Default to Sine if no waveform specifified
        this.WaveFormType = WaveFormType ?? VCOWaveformType.Sine;
    }
    #endregion
    ...
    public VCOWaveformType WaveFormType {
        get { return _WaveForm.Type; }
        set {
            _WaveForm.Type = value;
            _WaveForm = VCOWaveForm.GetByType(_WaveForm.Type);
