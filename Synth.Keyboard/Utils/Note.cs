...
internal class Note {
    ...
    public static Note GetByMidiNoteNumber(int ID) {
        const int MIDI_TO_SYNTH_NOTE_OFFSET = -32 + 24;
        return GetNoteList().Where(n => n.ID == ID + MIDI_TO_SYNTH_NOTE_OFFSET).First();
    }
